...
## b) Vector of years stored as strings (type chr) (correct)
...
## b) baseball$NumCompetitors = PlayoffTable[baseball$Year] (correct?)
## c) baseball$NumCompetitors = PlayoffTable(as.character(baseball$Year))
## d) baseball$NumCompetitors = PlayoffTable[as.character(baseball$Year)] (correct)
